...
romext := sfc
romfile := $(distdir)/pro_tracker_player.$(romext)
...
gfx_bg_8bpp_flags := $(verify) -optimize on -partitionTilemap on -tilethreshold $(threshold) -palettes 1 -bpp 8 -mode bg
...
gfx_bg_noop_flags := $(verify) -optimize off -partitionTilemap off  -tilethreshold 0 -palettes 1 -bpp 4 -mode bg
gfx_bg_lossy_flags := $(verify) -optimize on -partitionTilemap on -tilethreshold 160 -palettes 7 -bpp 4 -mode bg
gfx_bg_status_flags := $(verify) -optimize on -partitionTilemap on -tilethreshold 0 -palettes 4 -bpp 2 -mode bg
gfx_status_flags := $(verify) -optimize on -tilethreshold $(threshold) -palettes 4 -bpp 2 -mode bg
gfx_status_static_flags := $(verify) -optimize on -tilethreshold 0 -palettes 3 -bpp 2 -mode bg -statictiles on
gfx_level_flags := $(verify) -optimize on -collisionTileModifieable 4 -tilethreshold 0 -palettes 7 -bpp 4 -mode bg -maxtiles 768 -mapwidth 1024
...
gfx_sprite_flags := $(verify) -optimize on -palettes 2 -bpp 4 -mode sprite -tilemultiplier 4 -xMirrorTilemap on -bigtilethreshold 0 -maxbigtiles 1
...
gfx_sprite_halfbig_flags := $(gfx_sprite_flags) -baseframerate 1 -tilethreshold $(threshold) -bigtilethreshold 5
gfx_sprite_halfsmall_flags := $(gfx_sprite_flags) -baseframerate 1 -tilethreshold $(threshold) -bigtilethreshold 0 -maxbigtiles 0
gfx_sprite_quarter_flags := $(gfx_sprite_flags) -baseframerate 2 -tilethreshold $(threshold)
gfx_sprite_quarterbig_flags := $(gfx_sprite_flags) -baseframerate 2 -tilethreshold $(threshold) -bigtilethreshold 5
gfx_sprite_quartersmall_flags := $(gfx_sprite_flags) -baseframerate 2 -tilethreshold $(threshold) -bigtilethreshold 0 -maxbigtiles 0
